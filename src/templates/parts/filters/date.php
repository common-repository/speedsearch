 ...
 *          $filter_name
 *
 * This template can be overridden by copying it to yourtheme/speedsearch/themes/speedsearch_theme/templates/parts/filters/date.php.
 *
    ...
    if ( $display_for_settings ) {
        ...
        echo sanitize_user_field(
            ...
            "<div id=\"date-range\"></div>
                <div class=\"speedsearch-date-container\">
                <div class=\"speedsearch-date-input-container\">
                    <input class=\"speedsearch-date-input speedsearch-min-date-input\" type=\"text\">
                </div>
                <div class=\"speedsearch-separator\"></div>
                <div class=\"speedsearch-date-input-container\">
                    <input class=\"speedsearch-date-input speedsearch-max-date-input\" type=\"text\">
                </div>
            </div>",
            0,
            'display'
